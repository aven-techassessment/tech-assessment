...
/**
 * Model for the Images Object contained within the {@link Configuration} Endpoint
 * @see <a href="https://developers.themoviedb.org/3/configuration/get-api-configuration">/configuration</a>
 *
 * Note that I wrote this class and the {@link Configuration} class. All other model classes I used a generator for.
 *
 */
public class Images  {
